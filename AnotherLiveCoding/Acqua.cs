...
namespace CsharpShop2
{
    internal class Acqua : Prodotto
    {
        ...
        private string materialeBottiglie;
        private double ph;
        private string sorgente;
        private const double maxLitriBottiglia = 2;
        ...
        public void Bevi(double litriCheBevo)
        {
            if(litriCheBevo < 0)
            {
                throw new ArgumentOutOfRangeException("LitriCheBevo", "Il suo valore è negativo!");
                // Quando lanci un eccezione il programma si blocca.
            }
            if(litriCheBevo < 0.1)
            {
                throw new ArgumentOutOfRangeException("litriCheBevo", "Il suo valore è troppo basso");
            }
            ...
            else
            {
                ...
                this.litri = 0;
                throw new EmptyButtonException("La mia bottiglia è vuota");
            }
        }
